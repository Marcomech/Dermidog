export const FullDataBase: FullData[] = [
    {
        ID: "1",
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Ausente",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier raza, cualquier sexo, tiene mayor incidencia en animales adultos y de pelo largo",
            DIAGNÓSTICO: "El aspecto clónico y la evolución son característicos. Buscar los factores primarios que la desencadenan",
            DIAGNOSTICO_DIFERENCIAL: "Foliculitis piotraumática (piodermia profunda)",
            PRONÓSTICO: "Bueno",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier edad, cualquier sexo, cualquier raza aunque se presenta mós corrientemente en animales de pelo corto",
            DIAGNÓSTICO: "Observación microscópica del raspado y estudio citológico de los exudados. Cultivo bacteriano y antibiograma. Cultivo para dermatofitos. Biopsia cutánea. Radiografías. Estudio de la función tiroidea. Pruebas hematológicas y serológicas del laboratorio bioquímico para determinar el estado general del paciente",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Afecta particularmente a las razas con pliegues como: Bulldog, Pekines, Pug, Boston terrier, Shar-Pei, San Bernardo, Cocker spaniel , Basset hound. No hay predilección por sexo excepto en caso del pliegue vulvar y entre ambas mamas",
            DIAGNÓSTICO: "Por la localización de las lesiones",
            DIAGNOSTICO_DIFERENCIAL: "Dermatofitosis con infección bacteriana secundaria. Demodeccia. Candidiasis",
            PRONÓSTICO: "Bueno",
            TRATAMIENTO: "Higiene y desinfección. Definitivo es quirúrgico-estético. Disminución de peso en obesos",
            OBSERVACION_HISTOPATOLOGICA: "Vesículas esponjosas. -Edema intercelular. -Edema dérmico. -Vasculitis",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En animales jóvenes hasta el año de edad. Exclusivamente en razas de pelo corto, como Doberman, Bulldogs, Gran danós, Weimaraners, Rottweilers, Pointers, etc. cualquier sexo",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Animales adultos cualquier raza. Gran danós y San Bernardo en los codos y tarsos. En Dachshunds, Setter, Boxer, Doberman, el callo está en relación al esternón",
            DIAGNÓSTICO: "Por el aspecto clónico. Por la localización. Observación citológica. Si es necesario biopsia y observación histopatológica",
            DIAGNOSTICO_DIFERENCIAL: "Neoplasias. Cuerpos extraños. Bursitis",
            PRONÓSTICO: "Bueno",
            TRATAMIENTO: "Evitar que continúe el trauma, cambiando el lugar en donde el animal se acuesta, o colocando vendajes acolchados. En los casos más benignos cremas emolientes, antibióticas con o sin corticoides. En los casos más grave la resolución es quirúrgica",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Preferentemente cachorros cualquier raza, cualquier sexo hasta la pubertad",
            DIAGNÓSTICO: "Por la localización. Por las lesiones elementales. Por la edad del animal",
    ...
    },
    {
        ...
        DATA: {
            SINÓNIMO: "Foliculitis",
            ETIOLOGÍA: "Estafilococus pseudointermedius ofundamentalmente y algunas otras especies de estafilococos coagulasa positivo u otras bacterias. "
        }
    },
    {
        ID: "10",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Afecta animales adultos, de la raza ovejero alemán, y sus cruzas. cualquier sexo",
            DIAGNÓSTICO: "Anamnesis y excluyendo las hipersensibilidades. Biopsia, para diagnóstico histopatológico. Cultivo, aislamiento y antibiograma. El prurito debe cesar transitoriamente después de administrar el antibiótico específico. Determinación de las hormonas tiroideas",
            DIAGNOSTICO_DIFERENCIAL: "Demodeccia. Micobacterias. Micosis sistómicas y subcutáneas",
            PRONÓSTICO: "Reservado a malo. La respuesta al tratamiento la mayoría de las veces es sólo transitoria. Los tratamientos son paliativos debido a la dificultad de encontrar la enfermedad de base (ver 15)",
            SIMETRÍA: "simetrica"
        }
    },
    {
        ID: "13",
        NAME: "FISTULAS PERIANALES",
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En adultos, generalmente machos. Más frecuentemente en la raza Ovejero alemón y sus cruzas, aunque también en Gran danós, Setter irlandes, y otras",
            METODOS_DE_DIAGNÓSTICO: "Por la localización y el aspecto de la lesión. Biopsia para histopatología. Cultivo y antibiograma",
            DIAGNOSTICO_DIFERENCIAL: "Enfermedades autoinmunes. Neoplasia. Traumas. Lesión por contigüidad de los sacos anales. Tumor de glándulas circunanales",
    ...
    },
    {
        ...
        DATA: {
            ...
            DIAGNÓSTICO: "Dermograma patognomónico. Presencia de pulgas y/o sus excrementos",
            DIAGNOSTICO_DIFERENCIAL: "Atopía con la que puede coexistir. Alergia alimentaria, con la que puede coexistir. Piodermia superficial. Hipersensibilidad a los parásitos intestinales. Otras dermatitis seborreicas",
            PRONÓSTICO: "Malo porque no tiene cura. Bueno con tratamiento de mantenimiento y de por vida",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Desde muy jóvenes hasta adultos entre 1 a 3 años, cualquier raza, cualquier sexo., particularmente Terriers, Setter irlandós, Caniches, Dólmatas, Schnauzer y Ovejeros alemanes",
            METODOS_DE_DIAGNÓSTICO: "La anamnesis es de gran importancia, y además relacionarlo con lo estacional. Por los signos clínicos. Respuesta terapéutica a los corticoides. Intradermo-reacción. Pruebas serológicas para alergias (RAST y ELISA)"
        }
    },
    {
        ID: "18",
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Conjuntivitis. Rinitis. Lamido de las manos. Olor seborreico Adelgazamiento",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Desde muy jóvenes hasta adultos entre 1 a 3 años, cualquier raza, cualquier sexo., particularmente Terriers, Setter irlandós, Caniches, Dólmatas, Schnauzer y Ovejeros alemanes",
            METODOS_DE_DIAGNÓSTICO: "La anamnesis es de gran importancia, y además relacionarlo con lo estacional. Por los signos clínicos. Respuesta terapéutica a los corticoides. Intradermo-reacción. Pruebas serológicas para alergias (RAST y ELISA)"
        }
    },
    ...
    {
        ID: "20",
        NAME: "DERMATITIS ALÉRGICA POR CONTACTO CON ELEMENTOS DEL PISO",
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Desde jóvenes hasta adultos, afecta a cualquier sexo y a diferencia de la atopóa no hay predisposición racial",
            DIAGNÓSTICO: "Historia de contacto con un material determinado. Biopsia es poco útil, revela cambios inespecíficos. Pruebas con parches son poco prácticas",
    ...
    {
        ID: "21",
        NAME: "DERMATITIS ALÉRGICA POR CONTACTO CON ELEMENTOS PLÁSTICOS",
        DATA: {
            SINÓNIMO: "Hipersensibilidad por contacto. Alergia por contacto",
            ETIOLOGÍA: "Es una hipersensibilidad tipo IV, producida por diferentes alergenos, vegetales, minerales, industriales, etc",
            //AREA_INVOLUCRADA_DERMOGRAMA: {
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier edad, cualquier raza, cualquier sexo,",
            DIAGNÓSTICO: "A través de la respuesta a una dieta hipoalergénica (ver ítem 13)"
        }
    },
    {
        ID: "23",
        ...
        DATA: {
            ...
            OBSERVACION_HISTOPATOLOGICA: "Vesiculopustulosas sub-corneales, con elevada cantidad de neutrófilos y queratinocitos acantoliticos. -Afección de vaina radicular externa de los folículos pilosos. Edema dérmico con escasa cantidad de células inflamatorias",
            OTRAS_OBSERVACIONES: "Es la más frecuente de las enfermedades autoinmunes. Es una dermatitis pustular-costrosa, y No tiene una fase vesicular como en los seres humanos. Etiologías propuestas comunes a todas las enfermedades autoinmunes. Disfunción de células T supresoras. Interacción anormal de complejos de histocompatibilidad (CHC)"
        }
    },
    {
        ID: "24",
    ...
    },
    {
        ...
        DATA: {
            ...
            OBSERVACION_HISTOPATOLOGICA: "Dermatitis interfacial (hidrófica o liquenoide)",
            SIMETRÍA: "simétrica"
        }
    },
    {
    ...
    },
    {
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Prurito constante. Gran deterioro del estado general y a veces glomerulonefropatía en el Est. III",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier edad, cualquier raza, cualquier sexo,",
            DIAGNÓSTICO: "Reflejo oto pruriginoso NO patognomónico. Raspaje superficial de la piel, sólo positivo en un 20% de los casos. Por la respuesta a los acaricidas. Por la falta de respuesta a los corticoides",
            DIAGNOSTICO_DIFERENCIAL: "Atopía. Foliculitis bacterianas. Alergia alimentaria. Dermatitis de contacto. Dermatitis por Malassezia Dermatitis por otodectes. Dermatitis por Cheyletiella",
            PRONÓSTICO: "Bueno",
            TRATAMIENTO: "Baños con champú de peróxido de benzoilo, a modo de eliminar costras y permitir la penetración de los acaricidas. Amitraz 12.5% 2 ml/litro de agua una vez por semana, hasta un mes después de la mejoría clínica. Ivermectina 1%, 400mcg/kg intramuscular o subcutánea cada 15 días, cuidado con las razas susceptibles como Collies, Old english y sus cruzas",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Preferentemente en cachorros y jovenes, de todas las razas aunque hay algunas en que tiene mayor incidencia, como en Doberman, Boxer, Collies, Gran danes, etc. La presencia de demodeccia en los animales adultos hace necesario investigar aquellas patologías que alteran la inmunidad",
            DIAGNÓSTICO: "Observación microscópica de: -raspado superficial hasta sangrado -impronta de las secreciones de los folículos o pústulas. Cuenta diferencial entre huevos, ninfa, larvas y adultos posibilita un pronóstico",
            DIAGNOSTICO_DIFERENCIAL: "Foliculitis bacteriana. Tiña tricofóticas con infección secundaria. Pénfigo foliáceo y vulgaris. Lupus eritematoso. Seborreas. ALOPECIA POR MUTACION DE COLOR CELULITIS JUVENIL DERMATITIS DE LOS PLIEGUES DERMATITIS POR MALASSEZIA DERMATOFITOSIS POR MICROSPORUM DERMATOFITOSIS POR TRICOFITON DERMATOMIOSITIS DERMATOSIS QUE RESPONDE AL ZINC-I DERMATOSIS QUE RESPONDE AL ZINC-II FOLICULITIS BACTERIANA SUPERFICIAL FOLICULITIS Y FORUNCULOSIS DEL MENTON FOLICULITIS Y FORUNCULOSIS NASAL FOLICULITIS, FURUNCULOSIS Y CELULITIS HIPERSENSIBILIDAD BACTERIANA NO VERDADERA IMPETIGO PIODERMIA DEL OVEJERO ALEMAN",
            PRONÓSTICO: "Reservado a malo. Malo cuanto más edad tiene el animal",
    ...
    },
    {
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "No tiene",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Generalmente cachorros y jóvenes generalmente antes de alcanzar la madurez sexual",
            DIAGNÓSTICO: "Observación microscópica: -raspado profundo de la piel. Comparar la relación huevos, ninfas y adultos, para el efecto pronóstico",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Mós frecuentemente y los signos se manifiestan con mayor intensidad en los cachorros",
            DIAGNÓSTICO: "Observación directa del aspecto de la secreción del oído que será oscuro, seco y costroso. Observación directa con lupa, se ven los ácaros móviles. Observación de la secreción al microscopio. Por otoscopia",
            DIAGNOSTICO_DIFERENCIAL: "Atopía. Alergia alimentaria. Dermatitis alérgica a las pulgas. Sarna sarcóptica. Dermatitis por cheyletiella. Dermatitis por Mallazesia",
            PRONÓSTICO: "Bueno",
    ...
    },
    {
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Poliuria-polidipsia y posible polifagia. Debilidad muscular generalizada. Abdomen péndulo. Infecciones urinarias. Anestro y atrofia testicular. Diabetes mellitus con insulinoresistencia",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Adultos y viejos, sin predisposición por un sexo y mós frecuente en Dachshund, Caniches, Beagles, aunque cualquier otra raza puede estar afectada",
            METODOS_DE_DIAGNÓSTICO: "Análisis de orina con densidad muy baja. Hemograma característico desde el inicio de la enfermedad hormonal: leucocitosis, neutrofilia, linfopenia, eosinopenia. Fosfatasa alcalina elevada. Hiperlipemia. Confirmación a través de la prueba de estimulación con ACTH o de inhibición con Dexametasona. Disminución de las hormonas tiroideas. Hiperglucemia. Biopsia cutánea",
            DIAGNOSTICO_DIFERENCIAL: "Hiposomatotrofismo. Hipotiroidismo. Otros desbalances hormonales",
            PRONÓSTICO: "Reservado, en los casos primarios la curación de las manifestaciones dérmicas dependerá si se puede resolver la causa que le dió origen. Bueno en los casos iatrogénicos",
            TRATAMIENTO: "Desde hace años se utiliza Orto-Paraprima DDD, sin tener en cuenta la localización de la hipersecreción. También está recomendado el Ketoconazol. Actualmente están en estudio nuevos fármacos que actúan sobre el eje hipotálamo-pituitario-adrenal y otras que actúan sobre la glándula adrenal (Ver Bibliografía en ítem 16)"
        }
    },
    {
        ID: "35",
    ...
    {
        ID: "36",
        NAME: "DERMATOSIS POR HIPERESTROGENISMO",
        DATA: {
    ...
    {
        ID: "37",
        NAME: "DERMATOSIS POR HIPOESTROGENISMO",
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier edad, cualquier raza, cualquier sexo, se produce mós frecuentemente en animales castrados a temprana edad y de pelo corto",
            METODOS_DE_DIAGNÓSTICO: "Por la historia de la ovariectomía. Por la respuesta terapéutica. A través del diagnóstico diferencial con otras dermatopatías hormonales. La biopsia cutánea no es de gran utilidad",
    ...
    {
        ID: "38",
        NAME: "DERMATOSIS POR HIPOANDROGENISMO",
        DATA: {
            SINÓNIMO: "Síndrome de feminización idiopática",
            ETIOLOGÍA: "No se conoce (Ver ítem 15)"
        }
    },
    {
        ID: "39",
        NAME: "DERMATOSIS POR TUMOR DE CÉLULAS DE SERTOLI",
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Un testóculo agrandado, uno atrofiado o ectópico. Atracción sexual sobre otros machos. Prostatomegalia",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En los machos de cualquier raza, adultos y viejos",
            METODOS_DE_DIAGNÓSTICO: "Palpación testicular Ultrasonografía. La biopsia de la piel (No diagnóstica)"
        }
    },
    {
        ID: "40",
        NAME: "DERMATOSIS POR HIPOSOMATOTROFISMO DEL ADULTO",
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "No tiene",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En cualquier raza, aunque particularmente en Chow-chow, Caniche miniatura, Pomeranias, cualquier edad, preferentemente del sexo macho",
            METODOS_DE_DIAGNÓSTICO: "Por exclusión de otras endocrinopatías. Por histopatología, observación de la disminución de las fibras de elastina, después de dos años de evolución. La prueba de xilazina y clonidina son difíciles de realizar y No está al alcance del veterinario práctico",
            DIAGNOSTICO_DIFERENCIAL: "Hipotiroidismo. Hiperadrenocorticoidismo",
            PRONÓSTICO: "Reservado. Por la dificultad de confirmar el diagnóstico. Por la dificultad de realizar un tratamiento etiológico",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En cualquier edad, afecta a los animales más jóvenes y a los inmunosuprimidos. Sin predisposición racial",
            METODOS_DE_DIAGNÓSTICO: "Por los diagnósticos diferenciales con otras enfermedades dérmicas que producen Alopecia de aspecto circular. Por cultivo. Por contagio a otro animal o a los seres humanos. Sólo el 50% fluorescen a la lámpara de Wood. Las hifas y las artrosporas se ven en el microscopio hasta en el 70% de los casos. Histopatología con tinciones especiales (PAS)",
            SIMETRÍA: "asimétrica"
        }
    },
    {
        ID: "42",
        NAME: "DERMATOFITOSIS POR TRICOPHYITON",
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "Ausentes",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Mós frecuente en animales adultos",
            METODOS_DE_DIAGNÓSTICO: "Cultivo. Biopsia e histopatología con tinciones especiales (PAS)",
            SIMETRÍA: "asimétrica"
        }
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "En adultos de cualquier raza y sexo",
            DIAGNÓSTICO: "Por observación citológica del hisopado de piel o del conducto auditivo externo, tinción con azul de metileno o gram. Debe ser considerado siempre que haya una dermatitis descamativa, grasosa. Por los fracasos terapéuticos de otras dermatopatías que son sus diagnósticos diferenciales",
            DIAGNOSTICO_DIFERENCIAL: "Atopía. Piodermia superficial. Alergia alimentaria. Demodeccia. Sarna sarcóptica",
            PRONÓSTICO: "Bueno. Por tratarse de una contaminación secundaria se debe buscar la causa primaria o los factores predisponentes",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "cualquier edad, cualquier raza, cualquier sexo. Es más frecuentemente en los animales que están en contacto con la tierra",
            DIAGNÓSTICO: "El material debe obtenerse de la profundidad de los tractos fistulosos. Es difícil de observar el hongo, a través del examen citológico e histopatológico en los caninos. Cultivo del exudado en Saourand-dextrosa-agar o cerebro-corazón-agar",
            DIAGNOSTICO_DIFERENCIAL: "Con otras micosis sistémicas como histoplasmosis, criptococosis, blastomicosis, phaeohypomicosis y micetomas. Piodermia profunda. Fístulas crónicas. Neoplasias",
            PRONÓSTICO: "Bueno",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Dependen de la etiologóa",
            METODOS_DE_DIAGNÓSTICO: "Se deben aplicar los propios de cada etiología y además: Revisar la historia de la enfermedad. Conocer el tipo de dieta que recibe. Análisis de laboratorio bioquímico. Análisis coproparasitológico. Anólisis hormonales. Biopsia, raspajes y citología cutánea",
            ...
            TRATAMIENTO: "Curativo depende de la etiología. Control de la contaminación bacteriana secundaria y por Malassezia. Paliativo y empíricos"
        }
    },
    {
        ID: "47",
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Preferentemente Dachshunds, aunque tambión afecta a otras razas",
            METODOS_DE_DIAGNÓSTICO: "Por la apariencia clónica. Por biopsia",
            ...
            PRONÓSTICO: "Similar al de las seborreas primarias. La enfermedad puede controlarse, pero NO curarse",
            TRATAMIENTO: "El mismo que el de las seborreas. Durante las hemorragias, secar y colocar una gota de cianocrilato Quirúrgico",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Machos adultos",
            METODOS_DE_DIAGNÓSTICO: "Su localización es patonogmónica",
            DIAGNOSTICO_DIFERENCIAL: "Dermatofitosis microspórica",
            PRONÓSTICO: "Estéticamente malo",
            TRATAMIENTO: "Champús antiseborreicos, o con peróxido de benzoilo. Excisión quirúrgica estética. Castración",
    ...
    },
    {
        ...
        DATA: {
            ...
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Frecuentemente en adultos-viejos, sin predilección por raza ni sexo",
            METODOS_DE_DIAGNÓSTICO: "Signos clínicos y falta de otras lesiones dérmicas. Biopsia para realizar los diagnósticos diferenciales",
            DIAGNOSTICO_DIFERENCIAL: "Moquillo de las almohadillas plantares (Hard-pad Disease)"
        }
    },
    {
        ID: "50",
        ...
        DATA: {
            ...
            SIGNOS_CLINICOS_GENERALES: "No tiene",
            EDAD_RAZA_Y_SEXO_DE_PRESENTACION: "Históricamente en la raza Cocker spaniel, aunque también fue descrito en las razas Schnauzer miniatura y Labrador retriever",
            METODOS_DE_DIAGNÓSTICO: "Por las placas hiperqueratósicas. Por la gran cantidad de comedones foliculares. Confirmación sólo por la respuesta al tratamiento. La histopatología es orientadora",
            DIAGNOSTICO_DIFERENCIAL: "Seborreas primarias o secundarias. Dermatosis que responden al zinc. Callos. Adenitis sebácea",
            PRONÓSTICO: "Bueno",
            TRATAMIENTO: "0.000 UI de vitamina A por día, una vez al día. La mejoría comienza al mes y la curación completa se espera dentro del año. El tratamiento debe ser de por vida. Vitamina D o Calcitrol 10 nanogramos/kg/24h. Etretinato 1 mg/kg/24h",
