...
export const FullData: FullDataType[] = [
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: área de los pliegues",
        "De Dorsal: nariz y cola",
        "De Ventral: vulva y labios inferiores",
        "Puede afectar otros pliegues corporales como el pliegue umbilical y entre ambas cadenas mamarias como sucede en animales obesos"
      ],
      PRURITO: [
        "Ausente",
      ...
      TRATAMIENTO: [
        ...
        "Definitivo es quirúrgico-estético",
        "Disminucion de peso en animales obesos"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      ETIOLOGÍA: [
        "Erosión cutánea producida como consecuencia del rascado y / o lamido",
        "Los factores primarios pueden ser:",
        "Dermatitis alérgicas a las pulgas",
        "Lesiones de peinado o por cepillado agresivo",
        "Alergia alimentaria",
        "Otitis por otodectes",
        "Impacción de sacos anales",
        "Dermatitis atópica canina"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: cualquiera",
        "De Dorsal: frecuentemente en la cara externa de los muslos y base de la cola",
      ...
      DIAGNÓSTICO: [
        ...
        "Buscar los factores primarios que la desencadenan"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
      ...
      TRATAMIENTO: [
        ...
        "Raramente son necesarios antibióticos"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO: [
        "Por las localización",
        "Por las lesiones primarias",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: no tiene un patrón de distribución característico",
        "De Dorsal: frecuentemente De Dorsal y lateral del tórax, cuello y cabeza, lateral de miembros",
        "De Ventral: Abdomen y cara interna de los muslos"
      ],
      PRURITO: [
        "Leve"
      ],
      ...
      DIAGNÓSTICO: [
        ...
        "Citología",
        "Porhistopatología",
        "Por la respuesta a los antibióticos"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatofitosis por Microsporum",
        "Demodicosis",
      ...
      PRONÓSTICO: [
        "Bueno, aunque hay tendencia a repetirse a lo largo de la vida del perro"
      ],
      TRATAMIENTO: [
        "Antibioticoterapia sistémica por no menos de 15 días",
        "Baños con champú de peróxido de benzoilo o clohexidrina"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: areas alopécicas en cualquier parte de la superficie dérmica",
        "De Ventral: tiene predilección Ingles, axilas y abdomen"
      ],
      PRURITO: [
        "Leve a moderado"
      ],
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Ventral: abdomen, tórax y espacios interdigitales"
      ],
      PRURITO: [
        "Leve"
      ],
      ...
      TRATAMIENTO: [
        ...
        "Antibiótico señalado por el antibiograma durante 6 a 10 semanas",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Ventral: en el interior de los pabellones auriculares"
      ],
      PRURITO: [
        "Ausente"
      ],
      ...
      TRATAMIENTO: [
        "Se utilizara el antibiótico específico durante un mínimo de 21 días",
        "Evitar aumentar el trauma cuando se realiza la limpieza local",
        "Utilizar analgésicos y considerar colocar un collar isabelino"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      TRATAMIENTO: [
        "Antibióticos sistémicos por un mínimo de 21 dias",
        "Aplicación local de una crema con corticoide y antibióticos",
        "Aplicación local de Dimetilsulfoxido al 60 % en propilenglicol y corticoide",
  ...
  },
  {
    ...
    DATA: {
      ...
      ETIOLOGÍA: [
        "Es un complejo multifactorial con contaminación bacteriana secundaria, producida, entre otras; por las siguientes causas determinantes:",
        "Demodicosis",
        ...
        "Ancylostomiasis y uncinariasis ambiental",
        "Hipotiroidismo"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: en los espacios interdigitales y tejidos vecinos, de una o de las dos manos",
        "De Ventral: Los pies pueden estar involucrados"
      ],
      PRURITO: [
        "Leve",
        "Intenso: en las hipersensibilidades"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Ausente"
      ],
      ...
      DIAGNÓSTICO: [
        "Observación microscópica del raspado y estudio citológico de los exudados",
      ...
      PRONÓSTICO: [
        "Reservado a malo, por la dificultad de encontrar la causa"
      ],
      TRATAMIENTO: [
        "Antibioticoterapia",
        "Tratamiento de la causa primaria o de base",
        "Mantener limpia la región mediante pediluvios con champú de peróxido de benzoilo, o clorhexidina",
        "Evitar el trauma del lamido",
        "Calmar el dolor con analgésico",
        "Bajar el nivel de la sensibilidad dérmica mediante antidepresivos tricíclicos",
        "Considerar la escisión quirúrgica del tejido afectado"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Ventral: codos, tarsos y esternón"
      ],
      PRURITO: [
        "Ausente"
      ],
      ...
      DIAGNÓSTICO: [
        ...
        "Si es necesario biopsia y observación histopatológica"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Neoplasias",
        "Cuerpos extraños",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: comienza en la base de la cola o región lumbosacra",
        "De Ventral: cara interna de los muslos y área umbilical"
      ],
      PRURITO: [
        "Moderado a intenso"
      ],
      ...
      DIAGNÓSTICO: [
        "Dermograma patognomónico",
        "Presencia de pulgas y / o sus excrementos"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatitis atópica con la que puede coexistir",
        "Alergia alimentaria, con la que puede coexistir",
        "Piodermia superficial"
      ],
      PRONÓSTICO: [
        "Malo porque no tiene cura",
        "Bueno con tratamiento de mantenimiento y de por vida"
      ],
      TRATAMIENTO: [
        "Estricto control de las pulgas en el ambiente, y sobre el animal",
        "Evitar el contacto con el alérgeno, propuesta bastante difícil según las condiciones del hábitat y climáticas regionales",
        "Control del prurito, con corticoides, oclacitinib"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Dorsal:-desde la región lumbosacra se extiende en forma de triángulo con vértice hacia craneal, inserción de la cola, periné, región poplítea",
        "En Ventral:-en el abdomen, región inguinal y umbilical, cuello, cara interior de pabellón auricular"
      ],
      PRURITO: [
        "Intenso"
      ],
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatitis atópica con la que puede coexistir",
        "Alergia alimentarla, con la que puede coexistir",
        "Piodermia superficial"
      ],
      PRONÓSTICO: [
        "Malo porque no tiene cura",
      ...
      TRATAMIENTO: [
        "Estricto control de las pulgas en el ambiente, y sobre el animal",
        "Evitar el contacto con el alergeno, propuesta bastante difícil según las condiciones de hábitat y climáticas regionales",
        "Control del prurito, con corticoides, oclacitinib"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "SE INICIA SIN LESION DERMICA",
        "De Dorsal: área periocular e interdigital",
        "De Ventral: área perilabial"
      ],
      PRURITO: [
      ...
      TRATAMIENTO: [
        "Buscar el alergeno y evitar su contacto",
        ...
        "Tratamiento del prurito con corticoides, oclacitinib, ciclosporina, loquivetmab",
  ...
  },
  {
    ...
    DATA: {
      ...
      PRONÓSTICO: [
        "Reservado, dadas las características de enfermedad crónica e incurable",
        "Bueno, cuando el animal es sometido a un tratamiento de mantenimiento y de por vida"
      ],
      TRATAMIENTO: [
        "Buscar el alergeno y evitar su contacto",
  ...
  },
  {
    ...
    DATA: {
      ...
      SINÓNIMO: [
        ...
        "Alergia alimentaria",
        "Dermatitis atópica inducida por alimentos"
      ],
      ETIOLOGÍA: [
      ...
      DIAGNÓSTICO: [
        "A través de la respuesta a una dieta de eliminación o exclusión",
        "Descartando a sus diagnósticos diferenciales"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatitis atópica",
        "Dermatitis alérgica a las pulgas",
      ...
      PRONÓSTICO: [
        "'Bueno a reservado':",
        "Siempre que al mismo tiempo el animal no este afectado además de otras hipersensibilidades"
      ],
      TRATAMIENTO: [
        "Una dieta hipoalergénica estará compuesta por ingredientes que el animal nunca antes recibió, sin aditivos químicos, colorantes o preservantes",
        "Se pueden utilizar dietas específicamente formulada por empresas nutricionales",
        "Corticoides, oclacitinib",
        "Conocido el o los alimentos alergénicos, evitarlos"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: puede afectar todo el cuerpo de manera explosiva",
        "De Dorsal: nariz, área periocular, cara externa e interna de pabellones, almohadillas plantaras, y uñas",
        "De Ventral: ingles y amohadillas plantares"
      ],
      PRURITO: [
        "Leve",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: dentro de la cavidad bucal y en las uniones muco-cutaneas",
        "De Dorsal: bordes palpebrales y almohadillas plantaras",
        "De Ventral: labios-piel, fosas nasales-piel, prepucio-piel, vulva-piel, ano-piel, ingles y axilas, almohadillas plantaras"
      ],
      PRURITO: [
        "Leve",
      ...
      PRONÓSTICO: [
        "Grave, aun con tratamiento",
        "Fatal, sin él"
      ],
      TRATAMIENTO: [
        "Terapia imunosupresora:",
        "Dosis altas de corticoides",
        "Clorambucilo",
        "Azatioprina",
        "Ciclosporina",
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO_DIFERENCIAL: [
        ...
        "Necrólisis epidérmica tóxica",
        "Erupción por drogas",
        "Resto de las enfermedades subepiderrmicas"
      ],
      PRONÓSTICO: [
  ...
  },
  {
    ...
    DATA: {
      ...
      ETIOLOGÍA: [
        ...
        "Citocinas",
        "Se forman complejos inmunes que se depositan en distintos órganos"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: todo el cuerpo, sin un area definida y seborrea",
        "De Dorsal: nariz, periocular",
        "De Ventral: hiperqueratosis de las almohadillas plantares, en los pabellones auriculares"
      ],
      PRURITO: [
        "Leve",
        "Por contaminación bacteriana o Malazzesia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Intensa"
      ],
  ...
  },
  {
    ...
    DATA: {
      ...
      PRURITO: [
        "Ausente a leve",
        "Secundario por contaminación bacteriana"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Leve"
      ],
  ...
  },
  {
    ...
    DATA: {
      ...
      EDAD_RAZA_Y_SEXO_DE_PRESENTACION: [
        "Aunque no hay predisposición por edad o sexo, es raro en los cachorros",
        "Hay razas en la que es más frecuente como Collies y Shettland"
      ],
      DIAGNÓSTICO: [
        "Biopsia para:",
        "Histopatología",
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO: [
        ...
        "Inmunofluorescencia directa",
        "Aumento de las enzimas musculares(LDH-CPK-GOT)",
        "Electromiografia"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Demodicosis",
  ...
  },
  {
    ...
    DATA: {
      CODIGO: "5DEML",
      SINÓNIMO: [
        "Sarna demodectica localizada",
        "Sarna roja localizada"
      ],
      ETIOLOGÍA: [
        "Demodex canis"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: la alopecia parcial está distribuida en cualquier parte de la superficie dérmica",
        "De Dorsal: en la cabeza, miembros y región costal"
      ],
      PRURITO: [
        "Ausente",
        "Puede ser leve cuando hay contaminación bacteriana"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Ausente",
      ...
      EDAD_RAZA_Y_SEXO_DE_PRESENTACION: [
        "En Generalmente en cachorros y jóvenes antes de alcanzar la madurez sexual"
      ],
      DIAGNÓSTICO: [
      ...
      TRATAMIENTO: [
        "Baño general con amitraz de la misma forma que en la demodeccia generalizada",
        "Tópicos locales con una solución de 40 cc de vaselina líquida, 20 cc de dimetilsulfoxido a 90 %, y 2cc de amitraz al 12.5 %",
        "Tratamiento oral prolongado con Ivermectina o moxidectina",
        "Isoxazolinas"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: cualquiera",
        "De Dorsal: en la cabeza, dorso, miembros",
        "De Ventral: cuello, espacios interdigitales"
      ],
      PRURITO: [
        "Leve",
        "Por contaminación bacteriana"
      ...
      SIGNOS_CLINICOS_GENERALES: [
        ...
        "Linfoadenopatía localizada o generalizada"
      ],
      EDAD_RAZA_Y_SEXO_DE_PRESENTACION: [
      ...
      DIAGNÓSTICO: [
        "Raspado superficial hasta sangrado",
        "Extracción de pelos"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Foliculitis bacteriana",
        "Dermatofitosis por trichophyton",
        "Pénfigo foliaceo",
        "Lupus eritematoso",
        "Seborreas"
      ],
      PRONÓSTICO: [
        "Reservado a malo",
        "Malo cuanto más edad tiene el animal"
      ],
      TRATAMIENTO: [
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En los adultos:",
        "De Dorsal: bordes de las orejas, codos, tarsos",
        "De Ventral: abdomen y tórax en menor grado",
        "En los cachorros:",
        "De Ventral: abdomen y tórax en mayor grado",
        "Estadio I son cuadros con pocas lesiones dérmicas y gran prurito",
        "Estadio II es el cuadro típico y característico",
        "Estadio III cuadros crónicos que necesitan más diagnóstico diferencial"
      ],
      PRURITO: [
        "Intenso"
      ],
      ...
      SIGNOS_CLINICOS_GENERALES: [
        "Prurito constante",
        "En el Estadio III gran deterioro del estado general"
      ],
      EDAD_RAZA_Y_SEXO_DE_PRESENTACION: [
        "No tiene predilección por edad, raza o sexo"
      ],
      DIAGNÓSTICO: [
        "Reflejo otopruriginoso NO patognomónico, aunque orientativo",
        "Raspaje superficial de la piel, solo positivo en un 50-60 % de los casos",
        "Por la respuesta favorable a los acaricidas",
        "Por la falta de respuesta a los corticoides"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatitis atópica canina",
        "Foliculitis bacterianas",
      ...
      TRATAMIENTO: [
        "Baños con champú de peróxido de benzoilo, a modo de eliminar costras y permitir penetración de los acaricidas",
        "Amitraz 12.5 %, 2 cc / litro de agua una vez por semana, hasta un mes después de la mejoría clínica",
        "Ivermectina, via oral diariamente o bien 4OO mcg / kg intramuscular o subcutánea cada 15 días, teniendo precaución con las razas susceptibles como Collies, Old inglish sheep dog y pastor australiano y sus cruzas",
        "Isoxazolinas"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO: [
        ...
        "Observación de la secreción al microscopio",
        "Por otoscopía"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Dermatitis atópica",
      ...
      TRATAMIENTO: [
        "Lavar los conductos con shampoo de peróxido de benzoilo, a modo de eliminar costras y permitir penetración de los acaricidas",
        "Colocar una vez por semana una solución con 4Occ de vaselina líquida, 2º cc de dimetilsulfoxido al 90 % y 2cc de Amitraz al 12, 5 %",
        "Bañar a todo el animal con Amitraz 12, 51 / o, 2ccJlitro de agua una vez por semana, hasta un mes despues de la n~a",
        "Ivermectina 4OO mcg / kg subcutánea cada 15 días, 2 a 3 aplicaciones",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "NO tiene dermograma definido",
        "Los parásitos se observan en la superficie de los pelos, especialmente en cabeza, cuello y columna dorsal"
      ],
      PRURITO: [
        "Intenso"
      ],
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO_DIFERENCIAL: [
        "Alopecia x, ahora llamada detención del ciclo capilar",
        "Hipotiroidismo",
        "Otros desbalances hormonales"
      ],
      PRONÓSTICO: [
        "Reservado, en los casos primarios la curación de las manifestaciones dérmicas dependerá si se puede resolver la causa de hiperadrenocorticismo",
        "Bueno en los casos iatrogénicos"
      ],
      TRATAMIENTO: [
        "Mitotano",
        "Trilostano",
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO: [
        ...
        "Por histopatología, observación de algunas características como los folículos pilosos dispuestos como tentáculos de pulpo y que el pelo crece en el lugar de la biopsia"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Hipotiroidismo",
      ...
      PRONÓSTICO: [
        "Reservado:",
        "Por la dificultad de confirmar el diagnóstico",
        "Por la dificultad de realizar un tratamiento etiológico"
      ],
      TRATAMIENTO: [
        "Se han intentado muchos desde el punto de vista médico, estrógenos, progestágenos, andrógenos, hormona de crecimiento, mitotano, trilostano pero ninguno de ellos con una efectividad del 100 %",
        "También se indica la castración pero la respuesta no siempre es favorable"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "Alopecia:",
        "De Dorsal: las alopecias involucran los flancos, el área poplítea y cuello",
        "De Ventral: en todo el área desde las ingles hasta las axilas, ginecomastia y cara interna de las orejas"
      ],
      PRURITO: [
        "Ausente",
        "Secundario, por contaminación bacteriana y / o Malassezia"
      ...
      DIAGNÓSTICO: [
        ...
        "Ecografía abdominal",
        "La biopsia de la piel NO es diagnostica",
        "Biopsia de los testículos",
        "Respuesta después de la castración"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Hiperadrenocorticoidismo",
        "Hipotiroidismo",
  ...
  },
  {
    ...
    DATA: {
      CODIGO: "6HEST",
      SINÓNIMO: [
        "Desbalance ovárico hiperestrogénico",
      ...
      PRURITO: [
        "Ausente",
        "Secundario por contaminación bacteriana y / o por Malassezia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Leve"
      ],
      ...
      DIAGNÓSTICO_DIFERENCIAL: [
        ...
        "Si hay mucho prurito con hipersensibilidades como atopía, hipersensibilidad alimentaria, dermatitis alérgica de contacto"
      ],
      PRONÓSTICO: [
  ...
  },
  {
    ...
    DATA: {
      CODIGO: "6HIP",
      SINÓNIMO: [
        "Dermatosis por hipoestrogenismo",
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: las alopecias comienzan en los flancos; en el periné y posterior de muslos y pabellones auriculares",
        "De Ventral, desde las axilas hasta las ingles, cuello"
      ],
      PRURITO: [
        "Ausente"
      ],
      ...
      DIAGNÓSTICO: [
        ...
        "Por la respuesta terapéutica",
        "A través de diagnóstico diferencial con otras dermatopatías hormonales",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: cualquier área puede estar afectada",
        "De Dorsal: tiene predilección por las regiones con pelos más cortos como orejas, cara y miembros",
        "De Ventral: miembros"
      ],
      PRURITO: [
        "Ausente",
      ...
      EDAD_RAZA_Y_SEXO_DE_PRESENTACION: [
        "En cualquier edad, afecta a los animales más jóvenes y a los imunosuprimidos",
        "Sin predisposición racial"
      ],
      DIAGNÓSTICO: [
        "Por cultivo",
        "Por contagio a otro animal o a los seres humanos",
        "Solo el 50 % fluorescen a la lámpara de Wood",
        "Las artrosporas se ven en al microscopio hasta en el 70 % de los casos",
        "Histopatología con tinciones especiales(PAS)"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Con piodermia superficial diseminada, estas tienen la localización de las podermias y además siempre tienen algún pelo en su interior",
        "Demodicosis localizada",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: involucra superficies relativamente grandes",
        "De Dorsal: cualquier área pero frecuentemente cabeza, manos y patas"
      ],
      PRURITO: [
        "Ausente",
        "Secundario por contaminación bacteriana"
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: como contaminantes de alergias",
        "De Dorsal: en áreas de roce y HÚMEDAd como cuello, axilas cara interna de muslos, pliegue vulvar, región perianal, e interdigital",
        "De Ventral: en la cara interna de las orejas, labios, cuello e interdigital"
      ],
      PRURITO: [
        "Intenso"
      ],
      ...
      TRATAMIENTO: [
        "Con antifúngicos sistémicos como ketoconazol e itraconazol",
        "Baños con champú clorhexidina más acido propiónico"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      PRURITO: [
        "Leve",
        "Depende de la etiología y aumenta por contaminación bacteriana y / o Malassezia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Intensa"
      ],
      ...
      DIAGNÓSTICO_DIFERENCIAL: [
        "Con las seborreas secundarias",
        "Displasia epidérmica",
        "Adenitis sebácea",
        "Distrofia folicular",
        "Sindrome de comedones del Schnauzer"
      ],
      PRONÓSTICO: [
        "Malo en cuanto a la curación definitiva",
        "Puede ser tratado de por vida llegando a estados de aparente normalidad"
      ],
      TRATAMIENTO: [
        "Champúes antiseborreicos, el principio activo se debe elegir de acuerdo a los signos",
        "Corticoides por que inhiben la replicación celular",
        "Acido Retinoico",
        "Vitamina A",
        "Ácidos grasos omegas 3 y 6"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      PRURITO: [
        "Intenso",
        "Depende de la etiología, o es leve por contaminación bacteriana o Malassezia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Moderado a Intenso"
      ],
      ...
      DIAGNÓSTICO: [
        "Se deben aplicar los propios de cada etiología para poder aproximar o descartar y además",
        "Rever la historia de la enfermedad",
        "Conocer el tipo de dieta que recibe",
        "Análisis de laboratorio bioquímico",
        "Análisis coproparasitológico",
        "Análisis hormonales",
        "Biopsia, raspajes y citología cutánea"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
      ...
      TRATAMIENTO: [
        "Curativo depende de la etiología",
        "Control de la contaminación bacteriana secundaria y por Malassezia",
        "Paliativo y empíricos: champú antiseborreico, corticoides, vitamina A, ácido retinoico, ácidos grasos omega 3 y 6"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: alopecia parcial o total y simétrica en los bordes de las orejas",
        "De Ventral: igual"
      ],
      PRURITO: [
        "Leve",
        "Por contaminación bacteriana y / o Malassezia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Leve a moderada"
      ],
      ...
      PRONÓSTICO: [
        "El mismo que el de las seborreas primarias",
  ...
  },
  {
    ...
    DATA: {
      ...
      ETIOLOGÍA: [
        "Por seborreas primarias o secundarias",
        "Por desbalance de hormonas femeninas y masculinas"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Ventral: almohadillas plantaras"
      ],
      PRURITO: [
        "Ausente"
      ],
      ...
      DIAGNÓSTICO: [
        ...
        "Biopsia para realizar los diagnósticos diferenciales"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Moquillo",
      ...
      TRATAMIENTO: [
        "Hidratación diaria con agua en forma de pediluvios o compresas en la nariz",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Dorsal: lateral del tórax"
      ],
      PRURITO: [
        "Leve",
        "Secundario contaminación bacteriana y / o Malassezia"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Intensa"
      ],
      ...
      TRATAMIENTO: [
        "100 Unidades por kg de vitamina A, una vez al día",
        "El tratamiento debe ser de por vida",
        "Etretinato 1 mg / kg / 24h"
      ]
    }
  },
  {
    ...
    DATA: {
      CODIGO: "8CZ1",
      SINÓNIMO: [
        "Dermatopatía por carencia de ZINC",
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: en el hocico, alrededor de los ojos, codos, almohadillas plantaras",
        "De Ventral: en el área perilabial, cara interna de los pabellones auriculares, escroto, prepucio, vulva, codos, tarsos y almohadillas plantaras"
      ],
      PRURITO: [
        "Leve",
        "Por contaminación bacteriana y / o por Malassezia"
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: alopecia parcial",
        "De Dorsal: comienza en el dorso, luego afecta a toda la superficie cutánea, respetando la cabeza y lo miembros"
      ],
      PRURITO: [
        "Ausente",
  ...
  },
  {
    ...
    DATA: {
      ...
      SINÓNIMO: [
        ...
        "Nodulo prurítico acral"
      ],
      ETIOLOGÍA: [
        "Erosión producida por el lamido, debido a causas:",
        "Primarias psicogénicas",
        "Secundarias subyacentes como:",
        "Atopía",
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: lesiones únicas o múltiples",
        "De Dorsal: en craneal de los carpos o metacarpos",
        "De Ventral: en craneal de los radios, metatarsos y tibias"
      ],
      PRURITO: [
        "Intenso",
        "Manifestado por lamido obsesivo-compulsivo"
      ],
      SEBORREA_O_DESCAMACIÓN: [
        "Ausente"
      ],
      ...
      DIAGNÓSTICO: [
        "Por la localización de la lesión",
        "Por biopsia para histopatología",
        "Por radiología se debe observar si hay reacción perióstica"
      ],
      DIAGNÓSTICO_DIFERENCIAL: [
        "Callos de apoyo",
        "Dermatofitosis por microsporum",
  ...
  },
  {
    ...
    DATA: {
      ...
      DIAGNÓSTICO: [
        ...
        "Observación directa, presencia o NO de exudados",
        "Examen citológico del exudado",
        "Observación al microscopio de ectoparásitos",
      ...
      TRATAMIENTO: [
        "Etiológico, por las causas primarias que la produjeron",
        "Limpieza de los oídos con champú con peróxido de benzoilo, o clorhexidina",
        "Tratamiento local a través de numerosas formulaciones comerciales",
        "Tratamiento general de acuerdo a la etiología",
        "En caso de recidivas e imposibilidad de control, la resección de la porción vertical del conducto auditivo externo, es paliativo y facilita su limpieza"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      ETIOLOGÍA: [
        ...
        "Infección aguda o recidivante, por bacterias aeróbicas, anaeróbicas, o Malassezia"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
      ...
      TRATAMIENTO: [
        ...
        "5) Infección crónica Verdoso-rojoPastoso blando Fetido",
        "1) extrusión manual",
  ...
  },
  {
    ...
    DATA: {
      ...
      SINÓNIMO: [
        "'Piodemia'juvenil",
        "Dermatitis granulomatosa estéril"
      ],
      ETIOLOGÍA: [
        "Desconocida, probablemente se trate de una disfunción inmunológica"
      ],
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "De Dorsal: hocico, nariz, labios superiores y parpados",
        "De Ventral: alrededor de los labios y pabellones auriculares"
      ],
      PRURITO: [
        "Ausente"
      ],
      ...
      TRATAMIENTO: [
        ...
        "Soluciones astringente de Acetato de aluminio o Sulfato de magnesio",
        "Antibióticos, sí hay contaminación secundaria"
      ]
    }
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        "En General: alopecia parcial",
        "De Dorsal: área convexa de pabellones auriculares, área periauricular, posterior de muslos, periné",
        "De Ventral: cuello, pecho, abdomen"
      ],
      PRURITO: [
        "Ausente",
        "Secundario por piodermia",
  ...
  },
  {
    ...
    DATA: {
      ...
      AREA_INVOLUCRADA_DERMOGRAMA: [
        ...
        "De Ventral: borde de pabellones auriculares"
      ],
      PRURITO: [
        "Ausente"
      ],
