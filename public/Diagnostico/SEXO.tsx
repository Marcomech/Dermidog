const SexoValues = [
  ...
  " Aunque no hay predisposición por edad o sexo, es raro en los cachorros", "Hay razas en la que es más frecuente como Collies, Ovejeros alemanes, Siberian huskies",
  "Aunque no hay predisposición por edad o sexo, es raro en los cachorros", "Hay razas en la que es más frecuente como en el Ovejero Alemán",
...
export type SexoDetail = typeof SexoValues[number];
